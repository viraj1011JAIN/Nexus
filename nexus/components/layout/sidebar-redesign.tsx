...
export const Sidebar = () => {
  ...
  return (
    <div className="w-[280px] h-full bg-white dark:bg-[#1A1F2E] border-r border-[#E5E7EB] dark:border-[#252B3A] flex flex-col shadow-sm shrink-0 z-20">
      ...
      <div className="h-12 px-8 pt-8 pb-6 border-b border-[#E5E7EB] dark:border-[#252B3A]">
      ...
      <div className="px-3 py-6 border-t border-[#E5E7EB] dark:border-[#252B3A] space-y-3">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="w-full flex items-center justify-start gap-3 h-11 px-4 rounded-lg text-[#475569] dark:text-[#CBD5E1] hover:bg-[#F9FAFB] dark:hover:bg-[#252B3A] hover:text-[#374151] dark:hover:text-[#F1F5F9] transition-all duration-200 font-medium text-[15px]">
