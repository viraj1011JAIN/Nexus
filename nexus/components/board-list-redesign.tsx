    ...
    <div className="min-h-screen bg-[#FAFBFC] p-12">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <motion.form
          ...
          className="mb-12"
        >
          <div className="flex gap-4 max-w-2xl bg-white rounded-xl p-2 shadow-[0_1px_3px_rgba(0,0,0,0.06),0_1px_2px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.08),0_2px_4px_rgba(0,0,0,0.04)] transition-all duration-200">
            <input
              value={title}
              onChange={(e) => setTitle(e.target.value)}
              placeholder="Enter board name..."
              className="flex-1 px-6 py-3 text-[15px] text-[#0F172A] placeholder:text-[#94A3B8] outline-none bg-transparent"
              disabled={isPending}
              autoComplete="off"
            />
            <Button
              type="submit"
              disabled={isPending}
              className="h-12 px-6 bg-gradient-to-r from-[#7C3AED] to-[#A855F7] hover:brightness-110 text-white font-medium text-[15px] rounded-lg shadow-[0_2px_8px_rgba(124,58,237,0.25)] hover:shadow-[0_4px_12px_rgba(124,58,237,0.35)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-200"
            >
              {isPending ? (
        ...
        {boards.length === 0 ? (
          ...
          >
            ...
            <Button
              ...
              className="bg-gradient-to-r from-[#7C3AED] to-[#A855F7] hover:brightness-110 text-white font-medium text-[15px] px-6 py-3 rounded-lg shadow-[0_2px_8px_rgba(124,58,237,0.25)] hover:shadow-[0_4px_12px_rgba(124,58,237,0.35)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-200"
            >
              <Plus className="h-5 w-5 mr-2" />
              ...
              {boards.map((board, index) => (
                ...
                >
                  <Link href={`/board/${board.id}`}>
                    <div className="bg-white rounded-xl border border-[#E5E7EB] shadow-[0_1px_3px_rgba(0,0,0,0.05)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] hover:-translate-y-1 hover:scale-[1.01] transition-all duration-200 overflow-hidden h-80 flex flex-col cursor-pointer">
                      {/* Colored Header Area */}
                      <div
