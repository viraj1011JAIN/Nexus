      ...
      <header className="shrink-0 z-10 px-6 h-14 flex items-center justify-between bg-[rgba(255,253,249,0.92)] dark:bg-[rgba(13,12,20,0.85)] backdrop-blur-lg border-b border-b-black/8 dark:border-b-white/7 shadow-[0_1px_12px_rgba(0,0,0,0.06)] dark:shadow-none">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-[10px]">
            ...
            {/* Board title */}
            <h1 className="m-0 text-base font-bold tracking-[-0.02em] font-[family-name:var(--font-playfair)] whitespace-nowrap overflow-hidden text-ellipsis max-w-60 text-[#0F0D0B] dark:text-transparent dark:bg-gradient-to-br dark:from-[#C084FC] dark:via-[#F0ABFC] dark:to-[#818CF8] dark:bg-clip-text">
              {boardTitle}
            </h1>
