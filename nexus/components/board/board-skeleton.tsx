    ...
    <div className="min-h-screen bg-[#FAFBFC] p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 space-y-3">
          <div className="h-14 bg-gradient-to-r from-gray-200 to-gray-300 rounded-lg w-96 animate-pulse" />
        ...
        <div className="mb-12 flex gap-4 max-w-2xl">
          ...
          <div className="h-16 w-40 bg-gradient-to-r from-gray-200 to-gray-300 rounded-lg animate-pulse" />
        </div>
