...
const nextConfig: NextConfig = {
  ...
  // HTTP caching headers for static assets and API routes
  async headers() {
    return [
      {
        // Long-lived cache for all static assets generated by Next.js (_next/static)
      ...
      {
        // API routes: no store on browser, 30-second CDN cache
        source: "/api/:path*",
        headers: [
