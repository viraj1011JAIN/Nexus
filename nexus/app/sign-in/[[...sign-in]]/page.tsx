    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-slate-50 via-indigo-50 to-purple-50 px-4 py-8 sm:p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[95vw] sm:max-w-md mx-auto">
        <div className="text-center mb-4 sm:mb-6 md:mb-8 animate-fadeInUp">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-linear-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">
            Welcome Back
          </h1>
        ...
        <div className="glass-effect rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-2xl border-2 border-white/20 animate-scaleIn">
          <SignIn 
            ...
            appearance={{
              elements: {
                ...
                socialButtonsBlockButton: "glass-effect border-slate-200 hover:border-indigo-400 hover:bg-indigo-50 transition-all text-sm min-h-11",
                formButtonPrimary: "bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 transition-all hover:scale-105 active:scale-95 min-h-11",
                formFieldInput: "border-slate-200 focus:border-indigo-400 focus:ring-indigo-400 text-base min-h-11",
          ...
          <div className="relative my-4 sm:my-6">
            ...
            <div className="relative flex justify-center text-[10px] sm:text-xs uppercase">
              <span className="bg-white/80 px-2 sm:px-3 py-1 text-slate-500 font-semibold rounded-full">
                or try guest mode
              </span>
            </div>
          </div>
          ...
          <Button 
            ...
            size="lg"
            className="w-full bg-linear-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold shadow-lg hover:shadow-xl transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed min-h-11 text-sm sm:text-base"
          >
            {isDemoLoading ? (
          ...
          <div className="mt-3 sm:mt-4 p-2 sm:p-3 bg-amber-50 border border-amber-200 rounded-lg">
            <p className="text-[10px] sm:text-xs text-amber-800 text-center leading-relaxed">
