    ...
    <div className="min-h-[100dvh] flex items-center justify-center bg-[#0D0C14] relative overflow-hidden">
      ...
      <div className={`relative z-10 w-full max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8 py-8 transition-all duration-700 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-[20px]"}`}>
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          {/* Left — Branding + features (hidden on small screens, shown on lg+) */}
          <div className="hidden lg:flex flex-col flex-1 max-w-[440px] animate-auth-slide-right">
            ...
            <div className="space-y-4">
              {features.map((f, i) => (
                <div
                  key={f.label}
                  className="flex items-center gap-4 p-[14px] rounded-[14px] bg-white/[0.04] border border-white/[0.06] backdrop-blur-sm transition-all duration-300 hover:bg-white/[0.07] hover:border-purple-500/20"
          ...
          <div className="w-full max-w-[95vw] sm:max-w-[440px] lg:max-w-[420px]">
            {/* Mobile branding header (lg- only) */}
