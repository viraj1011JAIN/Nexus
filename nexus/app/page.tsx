...
export default function LandingPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      {/* Hero Section */}
      <section className="relative flex min-h-screen flex-col items-center justify-center gap-6 sm:gap-8 bg-linear-to-br from-slate-50 via-blue-50 to-indigo-50 px-4 sm:px-6 lg:px-10 py-8 sm:py-10 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-8 max-w-5xl mx-auto text-center">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-linear-to-br from-indigo-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg">
              <Sparkles className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
            </div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-linear-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
              NEXUS
            </h1>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight bg-linear-to-r from-slate-900 via-indigo-900 to-slate-900 bg-clip-text text-transparent">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-4 w-full sm:w-auto px-4 sm:px-0">
            <Link href="/sign-up" className="w-full sm:w-auto">
              <Button 
                size="lg"
                className="w-full sm:w-auto bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95 px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg font-semibold"
              >
                Get Started Free
          ...
          <div className="flex items-center gap-2 text-xs sm:text-sm text-slate-600 mt-6 sm:mt-8 px-4 sm:px-0">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-linear-to-br from-indigo-400 to-purple-400 border-2 border-white" />
              ))}
            </div>
      ...
      <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-10 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {/* Feature 1 */}
            <div className="group p-6 sm:p-8 rounded-2xl bg-linear-to-br from-indigo-50 to-purple-50 border border-indigo-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-linear-to-br from-indigo-600 to-purple-600 rounded-xl flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform">
            ...
            {/* Feature 2 */}
            <div className="group p-6 sm:p-8 rounded-2xl bg-linear-to-br from-blue-50 to-indigo-50 border border-blue-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-linear-to-br from-blue-600 to-indigo-600 rounded-xl flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform">
            ...
            {/* Feature 3 */}
            <div className="group p-6 sm:p-8 rounded-2xl bg-linear-to-br from-purple-50 to-pink-50 border border-purple-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-linear-to-br from-purple-600 to-pink-600 rounded-xl flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform">
      ...
      {/* Benefits Section */}
      <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-10 bg-linear-to-br from-slate-50 to-indigo-50">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="relative order-first md:order-last mb-8 md:mb-0">
              <div className="hidden sm:block aspect-square rounded-2xl bg-linear-to-br from-indigo-600 to-purple-600 shadow-2xl transform rotate-3 transition-transform hover:rotate-6" />
              <div className="relative sm:absolute inset-0 aspect-square rounded-2xl bg-white shadow-xl p-6 sm:p-8 flex items-center justify-center">
                <div className="text-center space-y-3 sm:space-y-4">
                  <div className="text-4xl sm:text-5xl lg:text-6xl font-bold bg-linear-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                    100%
                  </div>
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-10 bg-linear-to-br from-indigo-600 to-purple-600">
      ...
      <footer className="py-8 sm:py-10 lg:py-12 px-4 sm:px-6 lg:px-10 bg-slate-900 text-slate-400">
        <div className="max-w-6xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            <div className="w-7 h-7 sm:w-8 sm:h-8 bg-linear-to-br from-indigo-600 to-purple-600 rounded-lg flex items-center justify-center">
